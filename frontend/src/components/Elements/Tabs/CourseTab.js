              ...
              <nav>
                ...
                >
                  ...
                  <button
                    ...
                    aria-selected="false"
                  >
                    Data Science<span className="port-red">[01]</span>
                  </button>
                  <button
                    className="nav-link"
                    id="nav-contact-tab"
                    ...
                    aria-selected="false"
                  >
                    Development<span className="port-red">[03]</span>
                  </button>
                  <button
                    className="nav-link"
                    id="nav-contact-tabA"
                    ...
                    type="button"
                    role="tab"
                    aria-controls="nav-contactA"
                    aria-selected="false"
                  >
                    Business<span className="port-red">[01]</span>
                  </button>
                  <button
                    className="nav-link"
                    id="nav-contact-tabB"
                    data-bs-toggle="tab"
                    data-bs-target="#nav-contactB"
                    type="button"
                    role="tab"
                    aria-controls="nav-contactB"
                    aria-selected="false"
                  >
                    Life Styles<span className="port-red">[01]</span>
                  </button>
                </div>
              </nav>
            </div>
        ...
        <div className="course-main-items">
          ...
          >
                  ...
                  <div className="eduman-course-main-wrapper mb-30">
                        ...
                        <div className="cart-info-body">
                          ...
                          <div className="info-cart-text">
                            <ul>
                              ...
                              <li>
                                <i className="far fa-check"></i>Learn how to
                                code in Python
                              </li>
                              <li>
                                <i className="far fa-check"></i>Unlimited
                                backend database creation
                              </li>
                              <li>
                                <i className="far fa-check"></i>Adobe XD
                                Tutorials
                              </li>
                            </ul>
                          </div>
                    ...
                    <div className="eduman-course-thumb w-img">
                      <Link href="/course-details">
                        <a>
                          <img
                            src="assets/img/portfilo/course-img-01.jpg"
                            alt="course-img"
                          />
                        </a>
                      </Link>
                    ...
                    <div className="eduman-course-wraper">
                      <div className="eduman-course-heading">
                        <Link href="/course">
                          <a className="course-link-color-1">Development</a>
                        </Link>
                      ...
                      <div className="eduman-course-meta">
                        ...
                        <div className="eduman-course-tutor">
                          <img
                            src="assets/img/portfilo/course-tutor-01.png"
                            alt="image not found"
                          />
                  ...
                  <div className="eduman-course-main-wrapper mb-30">
                      ...
                      <div className="course-info-wrapper">
                        <div className="cart-info-body">
                          ...
                          <Link href="/course-details">
                            <a>
                              <h3>
                                Master Google Docs: Free online documents for
                                personal use
                              </h3>
                            </a>
                          </Link>
                    ...
                    <div className="eduman-course-thumb w-img">
                      <Link href="/course-details">
                        <a>
                          <img
                            src="assets/img/portfilo/course-img-02.jpg"
                            alt="course-img"
                          />
                        </a>
                      </Link>
                    ...
                    <div className="eduman-course-wraper">
                      ...
                      <div className="eduman-course-meta">
                        ...
                        <div className="eduman-course-tutor">
                          <img
                            src="assets/img/portfilo/course-tutor-02.png"
                            alt="image not found"
                          />
                          <Link href="/instructor-profile">
                            <a>
                ...
                <div className="col-xl-4 col-lg-4 col-md-6">
                  <div className="eduman-course-main-wrapper mb-30">
                    <div className="course-cart">
                      <div className="course-info-wrapper">
                        <div className="cart-info-body">
                          <span className="category-color category-color-3">
                            <Link href="/course">
                              <a>Business</a>
                            </Link>
                          </span>
                    ...
                    <div className="eduman-course-thumb w-img">
                      <Link href="/course-details">
                        <a>
                          <img
                            src="assets/img/portfilo/course-img-03.jpg"
                            alt="course-img"
                          />
                        </a>
                      </Link>
                    ...
                    <div className="eduman-course-wraper">
                      <div className="eduman-course-heading">
                        <Link href="/course">
                          <a className="course-link-color-3">Business</a>
                        </Link>
                        <span className="couse-star">
                          <i className="fas fa-star"></i>4.9 (25)
                        </span>
                      ...
                      <div className="eduman-course-meta">
                        ...
                        <div className="eduman-course-tutor">
                          <img
                            src="assets/img/portfilo/course-tutor-03.png"
                            alt="image not found"
                          />
                          <Link href="/instructor-profile">
                            <a>
                  ...
                  <div className="eduman-course-main-wrapper mb-30">
                    ...
                    <div className="eduman-course-thumb w-img">
                      <Link href="/course-details">
                        <a>
                          <img
                            src="assets/img/portfilo/course-img-05.jpg"
                            alt="course-img"
                          />
                        </a>
                      </Link>
                    ...
                    <div className="eduman-course-wraper">
                      ...
                      <div className="eduman-course-meta">
                        ...
                        <div className="eduman-course-tutor">
                          <img
                            src="assets/img/portfilo/course-tutor-05.png"
                            alt="image not found"
                          />
                          <Link href="/instructor-profile">
                            <a>
                              <span>Edyal Romel</span>
                            </a>
                          </Link>
                        </div>
                      </div>
                ...
                <div className="col-xl-4 col-lg-4 col-md-6">
                  <div className="eduman-course-main-wrapper mb-30">
                    <div className="course-cart">
                      <div className="course-info-wrapper">
                        <div className="cart-info-body">
                          <span className="category-color category-color-5">
                            <Link href="/course">
                              <a>Data Science</a>
                            </Link>
                          </span>
                    ...
                    <div className="eduman-course-thumb w-img">
                      <Link href="/course-details">
                        <a>
                          <img
                            src="assets/img/portfilo/course-img-06.jpg"
                            alt="course-img"
                          />
                        </a>
                      </Link>
                    ...
                    <div className="eduman-course-wraper">
                      <div className="eduman-course-heading">
                        <Link href="/course">
                          <a className="course-link-color-5">Data Science</a>
                        </Link>
                        <span className="couse-star">
                          <i className="fas fa-star"></i>4.9 (25)
                        </span>
                      ...
                      <div className="eduman-course-meta">
                        ...
                        <div className="eduman-course-tutor">
                          <img
                            src="assets/img/portfilo/course-tutor-06.png"
                            alt="image not found"
                          />
                          <Link href="/instructor-profile">
                            <a>
                ...
                <div className="col-xl-4 col-lg-4 col-md-6">
                  <div className="eduman-course-main-wrapper mb-30">
                    <div className="course-cart">
                      <div className="course-info-wrapper">
                        <div className="cart-info-body">
                          <span className="category-color category-color-4">
                            <Link href="/course">
                              <a>Life Style</a>
                            </Link>
                          </span>
                          <Link href="/course-details">
                            <a>
                              <h3>
                                Become a Super Human: Naturally and Safely Boost
                              </h3>
                            </a>
                          </Link>
                          <div className="cart-lavel">
                    ...
                    <div className="eduman-course-thumb w-img">
                      <Link href="/course-details">
                        <a>
                          <img
                            src="assets/img/portfilo/course-img-04.jpg"
                            alt="course-img"
                          />
                        </a>
                      </Link>
                    ...
                    <div className="eduman-course-wraper">
                      <div className="eduman-course-heading">
                        <Link href="/course">
                          <a className="course-link-color-4">Life Style</a>
                        </Link>
                        <span className="couse-star">
                          <i className="fas fa-star"></i>4.9 (25)
                        </span>
                      ...
                      <div className="eduman-course-meta">
                        ...
                        <div className="eduman-course-tutor">
                          <img
                            src="assets/img/portfilo/course-tutor-04.png"
                            alt="image not found"
                          />
                          <Link href="/instructor-profile">
                            <a>
            ...
            <div
              ...
              id="nav-contactA"
              role="tabpanel"
              aria-labelledby="nav-contact-tabA"
            >
              <div className="row">
                <div className="col-xl-4 col-lg-4 col-md-6">
                  <div className="eduman-course-main-wrapper mb-30">
            ...
            <div
              ...
              id="nav-contactB"
              role="tabpanel"
              aria-labelledby="nav-contact-tabB"
            >
              <div className="row">
                <div className="col-xl-4 col-lg-4 col-md-6">
                  <div className="eduman-course-main-wrapper mb-30">
